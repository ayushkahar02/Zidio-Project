        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <div className="flex mt-[20px] items-center justify-center">
            <button
              type="button"
              onClick={onClose}
              className="bg-white text-[#000000] hover:text-white border border-[#8357DA] py-2 w-[100px] h-[45px] hover:bg-[#8357DA] text-[18px]"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="bg-white text-[#000000] hover:text-white border border-[#8357DA] py-2 w-[100px] h-[45px] hover:bg-[#8357DA] ml-[20px] text-[18px]"
            >
              Add
            </button>
          </div>
  ...
  return (
    <div className="flex h-screen w-screen bg-gray-100">
      ...
      <div className="flex-1 overflow-y-auto p-6 ml-[50px]">
        <div className="flex flex-col mt-10px w-full mt-[50px] p-4 bg-white rounded shadow h-[700px]">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-[30px] font-bold text-[#8357DA]">Team Members</h2>
            {role === "admin" && (
              <button
                onClick={handleOpenModal}
                className="bg-white text-[#000000] px-4 py-2 rounded border border-[#8357DA] hover:bg-[#8357DA] hover:text-white"
              >
                +Assign Task
              </button>
            )}
